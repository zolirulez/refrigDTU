...
function Inputs = preProcess(Inputs,pp)
% In this function, only controller related inputs are changed
pp.Inputs.recValveInputs.capacityRatio = Inputs.recValveInputs.capacityRatio;
pp.Inputs.HPValveInputs.capacityRatio = Inputs.HPValveInputs.capacityRatio;
end
